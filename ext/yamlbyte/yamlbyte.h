...
typedef const yamlbyte_char_t *yamlbyte_buffer_t; 
...
typedef 
   yamlbyte_result_t
    (*yamlbyte_pull_t)(
      ...
      yamlbyte_buffer_t  *buff   /* to be filled in by the producer */
    ); 

/* Generated by re2c 0.5 on Sat Mar 29 17:53:55 2003 */
#line 1 "token.re"
//
// token.re
//
...
yy92:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy93:	if(yybm[0+yych] & 64)	goto yy92;
	goto yy90;
yy94:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy95:	if(yybm[0+yych] & 128)	goto yy94;
	goto yy87;
yy96:	yych = *++YYCURSOR;
	goto yy84;
yy97:	yych = *++YYCURSOR;
...
yy133:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy134:	if(yybm[0+yych] & 64)	goto yy133;
	if(yych != ' ')	goto yy128;
yy135:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;

/* Generated by re2c 0.5 on Tue May  6 01:31:44 2003 */
#line 1 "token.re"
//
// token.re
//
...
yy112:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy113:	if(yybm[0+yych] & 64)	goto yy112;
	goto yy106;
yy114:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy115:	if(yybm[0+yych] & 128)	goto yy114;
	goto yy101;
yy116:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
...
yy134:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy135:	if(yybm[0+yych] & 64)	goto yy134;
	if(yych != ' ')	goto yy126;
yy136:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy137:	if(yybm[0+yych] & 128)	goto yy136;
	goto yy126;
}
#line 432
...
yy148:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy149:	if(yybm[0+yych] & 32)	goto yy148;
	if(yych == '\n')	goto yy151;
yy150:	YYCURSOR = YYMARKER;
	switch(yyaccept){
	case 0:	goto yy143;
	}
yy151:	yych = *++YYCURSOR;
...
yy155:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy156:	if(yybm[0+yych] & 64)	goto yy155;
	if(yych != ' ')	goto yy141;
yy157:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy158:	if(yybm[0+yych] & 128)	goto yy157;
	goto yy141;
}
#line 529
...
yy167:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy168:	if(yybm[0+yych] & 64)	goto yy167;
	goto yy163;
yy169:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy170:	if(yybm[0+yych] & 128)	goto yy169;
	goto yy163;
}
#line 584
...
yy181:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy182:	if(yybm[0+yych] & 64)	goto yy181;
	if(yych != ' ')	goto yy174;
yy183:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy184:	if(yybm[0+yych] & 128)	goto yy183;
	goto yy174;
}
#line 690
...
yy192:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy193:	if(yybm[0+yych] & 128)	goto yy192;
	goto yy188;
}
#line 714

/* Generated by re2c 0.5 on Thu May  1 17:36:26 2003 */
#line 1 "token.re"
//
// token.re
//
...
yy150:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy151:	if(yybm[0+yych] & 64)	goto yy150;
	goto yy146;
yy152:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy153:	if(yybm[0+yych] & 128)	goto yy152;
	goto yy146;
}
#line 473
...
yy164:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy165:	if(yybm[0+yych] & 64)	goto yy164;
	if(yych != ' ')	goto yy157;
yy166:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy167:	if(yybm[0+yych] & 128)	goto yy166;
	goto yy157;
}
#line 552
...
yy175:	++YYCURSOR;
	if(YYLIMIT == YYCURSOR) YYFILL(1);
	yych = *YYCURSOR;
yy176:	if(yybm[0+yych] & 128)	goto yy175;
	goto yy171;
}
#line 576
